...
public class MessageListener {
    ...
    @RabbitListener(queues = "#{queueConfiguration.simpleConnection}",
    ...
    @RabbitListener(queues = "#{queueConfiguration.vendorEvents}",
    ...
    @RabbitListener(queues = "#{queueConfiguration.eventTickets}",
            containerFactory = AppConstants.JSON_RABBIT_CONTAINER_FACTORY)
